...
<style>
  .editActiviesInfo .textAreaBox textarea{
    width: 100%;
    border: none;
    font-size: 32px;
    line-height: 60px;
  ...
  .editActiviesInfo textarea:-ms-input-placeholder{
    font-size: 32px;
    line-height: 60px;
    color: #909090 !important;
  }
  .editActiviesInfo textarea::-moz-placeholder{
    font-size: 32px;
    line-height: 60px;
    color: #909090 !important;
  }
  .editActiviesInfo textarea::-webkit-input-placeholder{
    font-size: 32px;
    line-height: 60px;
    color: #909090 !important;
  }
  .editActiviesInfo .mint-popup{
    width: 100%;
    transition: .3s ease-out;
  }
  .editActiviesInfo .picker{
    width: 100%;
    background: #fff;
  }
  .editActiviesInfo .picker-toolbar{
    height: 70px;
    padding: 0 100px;
  }
  .editActiviesInfo .picker-toolbar-title{
    display: flex;
    flex-direction: row;
  ...
  .editActiviesInfo .picker-slot{
    font-size: 27px;
  }
  .editActiviesInfo .usi-btn-cancel,
  .editActiviesInfo .usi-btn-sure {
    text-align: center;
    color: #fac31e
  }
  .editActiviesInfo .usi-btn-cancel{
  ...
  .editActiviesInfo .mint-datetime-action{
    width: 20%;
    line-height: 70px;
    color: #fac31e;
    font-size: 30px;
  }
  .editActiviesInfo .mint-datetime-cancel{
    color: rgb(139, 138, 138)
  }
  ...
  .editActiviesInfo .el-date-editor--time-select .el-input__prefix{
    display: none;
  }
  .editActiviesInfo .el-date-editor--time-select .el-input__suffix{
    display: none;
  }
  .editActiviesInfo .el-date-editor--time-select .el-input{
    border: none;
  }
  .time-select-item{
    height: 65px;
